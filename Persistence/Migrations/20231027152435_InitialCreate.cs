    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    UrlSmall = table.Column<string>(type: "text", nullable: true),
                    UrlLarge = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductExperts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    DiscountValue = table.Column<decimal>(type: "numeric", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ProductExpertId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_ProductExperts_ProductExpertId",
                        column: x => x.ProductExpertId,
                        principalTable: "ProductExperts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerDetailsProduct", x => new { x.CustomerDetailsId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_CustomerDetailsProduct_CustomerDetails_CustomerDetailsId",
                        column: x => x.CustomerDetailsId,
                        principalTable: "CustomerDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerDetailsProduct_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerDetailsProduct_ProductId",
                table: "CustomerDetailsProduct",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductExpertId",
                table: "Products",
                column: "ProductExpertId");
        }
